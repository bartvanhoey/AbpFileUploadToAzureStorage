...
namespace AbpFileUploadToAzureStorage.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpFileUploadToAzureStorageDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpFileUploadToAzureStorageEfCoreEntityExtensionMappings to extend the IdentityUser entity
